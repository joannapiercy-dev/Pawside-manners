...
function renderMedsReference(deck) {
  const medMeta = {
    'm-01':  { freq: 'BID', food: true },
    'm-01b': { freq: 'BID then SID', food: false },
    'm-02':  { freq: 'SID or EOD', food: false },
    'm-03':  { freq: 'SID', food: true },
    'm-04':  { freq: 'SID', food: false },
    'm-05':  { freq: 'PRN', food: false },
    'm-06':  { freq: 'SID', food: false },
    'm-07':  { freq: 'BID', food: true },
    'm-08':  { freq: 'BID', food: true },
    'm-09':  { freq: 'SID', food: false },
    'm-10':  { freq: 'Single injection', food: false },
    'm-11':  { freq: 'SID', food: true },
    'm-12':  { freq: 'SID', food: true },
    'm-13':  { freq: 'BID', food: true },
    'm-14':  { freq: 'BID', food: false },
    'm-15':  { freq: 'BID', food: true },
    'm-16':  { freq: 'SID', food: false },
    'm-17':  { freq: 'BID–TID', food: false },
    'm-18':  { freq: 'BID–TID', food: false },
    'm-19':  { freq: 'SID', food: true },
    'm-20':  { freq: 'SID', food: false },
    'm-21':  { freq: 'BID', food: true },
    'm-22':  { freq: 'SID', food: true },
    'm-23':  { freq: 'BID', food: true },
    'm-24':  { freq: 'SID (transdermal)', food: false },
    'm-25':  { freq: 'SID (oral)', food: false },
    'm-25b': { freq: 'Single injection', food: false },
    'm-26':  { freq: 'SID', food: false },
    ...
    'm-37':  { freq: 'SID', food: false },
    'm-39':  { freq: 'SID', food: true },
    'm-40':  { freq: 'SID', food: false },
    'm-41':  { freq: 'SID', food: false },
  };
