  ...
  }  ,
  {
    ...
    terms: [
      ...
      },
      {
        ...
        pronunciation: "",
        meaning: "Topical spot-on for cats. Covers fleas ONLY. Applied monthly. Does NOT require a prescription — classified as a pesticide rather than a drug. Active ingredients: imidacloprid, pyriproxyfen. Safe for use in cats (unlike Advantix, which is for dogs only and toxic to cats).",
        clientExplanation: "Advantage II is a flea-only spot-on that doesn't need a prescription — it's a pesticide rather than a drug. It's a simple, accessible option if fleas are the only concern for your cat.",
      ...
      },
      {
        ...
        pronunciation: "",
        meaning: "Most parasiticides at this clinic require a valid veterinarian-client-patient relationship (VCPR) and a prescription. The exception is Advantage II (for both dogs and cats), which is classified as a pesticide and available over the counter. Clients sometimes ask why they need a prescription — the answer is that prescription products are generally more effective and some (like Bravecto injectable) require professional administration.",
        clientExplanation: "Most of our parasite prevention products are prescription-only — that means your pet needs to be a current patient here. The main exception is Advantage II for dogs and cats, which you can pick up without a prescription. If your pet isn't due for a visit, call us and we can advise on what's available.",
        category: "General"
      },
      {
        id: "p-19",
