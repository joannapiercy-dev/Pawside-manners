export const triageReference = {
  ...
  urinary: {
    ...
    rows: [
      ...
      { sign: "Urinating much more frequently AND drinking much more — energy and appetite normal", outcome: "ROUTINE", note: "Polyuria/polydipsia (PUPD) with no other symptoms — significant finding but stable. Book a routine appointment for bloodwork and urinalysis to investigate the underlying cause (possible early diabetes, kidney disease, or other systemic illness)." },
      { sign: "Urinating much more frequently AND drinking much more — energy or appetite reduced", outcome: "URGENT", note: "PUPD with reduced energy or appetite — possible diabetes, kidney disease, Addison's disease, or other systemic illness. Needs same-day assessment." },
