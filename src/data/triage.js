...
export const triageQuizzes = {
  vomiting: [
    {
      ...
      "Tell them to monitor for another hour",
      "Treat as emergency — come in immediately",
      "Ask if he ate anything unusual and book a routine appointment"
      ],
      correct: 2,
    ...
    },
    {
      ...
      options: [
      "Emergency — come in now",
      "Same-day appointment",
      "Monitor at home — call back if it continues or they stop drinking",
      "Routine appointment"
      ],
      correct: 2,
  ...
  diarrhea: [
    ...
    },
    {
      ...
      "Emergency",
      "Same-day appointment",
      "Monitor at home — bland diet, call back if worsening",
      "Routine appointment"
      ],
      correct: 2,
  ...
  urinary: [
    {
      ...
      options: [
      "Book a same-day appointment",
      "Tell her to monitor until tomorrow",
      "Emergency — come in immediately",
      "Book within 48 hours"
      ],
      correct: 2,
  ...
  lameness: [
    ...
    },
    {
      ...
      correct: 2,
      explanation: "Complete non-weight bearing without known trauma — possible fracture, dislocation, or severe soft tissue injury. Same-day assessment whenever possible.  If the pet is touching the toe to the ground, can sometimes wait until the next day."
    },
    {
  ...
  eyes: [
    ...
    },
    {
      ...
      options: [
      "Same urgency as any other dog",
      "Slightly more urgent — brachycephalic breeds have higher corneal risk",
      "Less urgent — their eyes are always a bit unusual",
      "Only urgent if the eye is completely closed"
      ],
      correct: 1,
    ...
    },
    {
      ...
      "Same day if possible",
      "Within 48 hours",
      "Routine — monitor, call back if persistent"
      ],
      correct: 3,
  ...
  wounds: [
    {
      ...
      options: [
      "Book same-day appointment",
      "Emergency — apply pressure and come in immediately",
      "Monitor at home",
      "Book within 48 hours"
      ],
      correct: 1,
    ...
    },
    {
      ...
      "Same day if possible",
      "Within 48 hours",
      "Clean at home, monitor, routine appointment if not healing"
      ],
      correct: 3,
    ...
    },
    {
      ...
      options: [
      "It doesn't — minor wounds near joints are fine to monitor",
      "Risk of joint cavity involvement — infection in a joint is very serious",
      "Only if the dog is limping",
      "Only if the wound is deep"
      ],
      correct: 1,
    ...
    },
    {
      ...
      options: [
      "Monitor — this is normal healing",
      "Routine appointment",
      "Within 48 hours",
      "Same day if possible"
      ],
  ...
  neuro: [
    {
      ...
      options: [
      "Tell the owner to wait and see if it stops",
      "Book a same-day appointment for when it stops",
      "Emergency — come in immediately, keep away from hard surfaces",
      "Book within 48 hours"
      ],
      correct: 2,
    ...
    {
      q: "A cat suddenly cannot walk and is dragging its back legs. What urgency?",
      options: [
      "Same day if possible",
      "Within 48 hours",
      "Emergency",
  ...
  lethargy: [
    ...
    },
    {
      ...
      "Same day",
      "Within 48 hours",
      "Monitor for 12–24 hours, call back if worsening"
      ],
      correct: 3,
  ...
  toxins: [
    {
      ...
      options: [
      "Monitor at home — she seems fine",
    ...
    },
    {
      ...
      "Book a same-day appointment",
      "Tell the owner to wash it off and monitor",
      "Emergency — wash off immediately and come in"
      ],
      correct: 3,
    ...
    },
    {
      ...
      options: [
      "Monitor at home — cannabis isn't fatal in dogs",
      "Same day",
      "Within 48 hours",
      "Emergency"
      ],
    ...
    },
    {
      ...
      "Same day if showing symptoms",
      "Emergency regardless of symptoms",
      "Within 48 hours"
      ],
      correct: 2,
    ...
    },
    {
      ...
      options: [
      "Monitor at home — a small amount is probably fine",
      "Same day to be safe",
      "Emergency",
      "Call back only if vomiting starts"
      ],
      correct: 2,
    ...
    },
    {
      ...
      options: [
      "Choking risk only — monitor at home",
      "Chemical burns from leaking alkali — same-day assessment, do not induce vomiting",
      "Heavy metal poisoning — emergency",
      "The battery will pass safely — no action needed"
      ],
      correct: 1,
    ...
    },
    {
      ...
      options: [
      "Monitor at home — compost isn't toxic",
      "Same day",
      "Within 48 hours",
      "Emergency"
      ],
    ...
    },
    {
      ...
      options: [
      "Monitor at home — small amounts are unlikely to cause harm",
      "Same day appointment",
      "Call back if symptoms develop",
      "Emergency — come in immediately even if asymptomatic"
      ],
      correct: 3,
    ...
    },
    {
      ...
      options: [
      "Monitor at home — it's just a skin cream",
      "Same day",
      "Within 48 hours",
      "Emergency"
      ],
    ...
    },
    {
      ...
      options: [
      "Monitor — if the dog seems fine, the mushroom is probably harmless",
      "Same day if symptoms develop",
      "Emergency regardless of symptoms",
      "Within 48 hours"
      ],
      correct: 2,
    ...
    },
    {
      ...
      options: [
      "Monitor at home — outdoor plants are rarely toxic",
      "Same day",
      "Within 48 hours",
      "Emergency"
      ],
    ...
    },
    {
      ...
      options: [
      "Aspartame — monitor at home",
      "Xylitol — emergency, causes rapid hypoglycaemia and potentially liver failure",
      "Sorbitol — same day as a precaution",
      "Artificial sweeteners are harmless to dogs"
      ],
      correct: 1,
