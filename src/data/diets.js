    ...
    dogs: [
      {
        ...
        forms: ['dry', 'canned'],
        flavour: "Loaf / Ultra Soft Mousse in Sauce (canned); Original (dry)",
      ...
      },
      {
        ...
        forms: ['dry', 'canned'],
        flavour: "Loaf / Mousse (canned); Original (dry)",
      ...
      },
      {
        ...
        forms: ['dry', 'canned'],
        flavour: "Loaf (canned); Original (dry)",
      ...
      },
      {
        ...
        forms: ['dry', 'canned'],
        flavour: "Ultra Soft Mousse (canned); Original (dry)",
      ...
      },
      {
        ...
        forms: ['dry', 'canned'],
        flavour: "Savory Turkey (dry); Canine/Turkey & Rice (canned)",
      ...
      },
      {
        ...
        forms: ['dry', 'canned'],
        flavour: "Natural Turkey (dry & canned)",
    ...
    ,
      {
        ...
        forms: ["dry", "canned"],
        flavour: "Digestive Care (dry & canned)",
      ...
      },
      {
        ...
        name: 'i/d',
        forms: ["dry", "canned"],
        flavour: "Original (dry); Chicken & Vegetable Stew / Chicken (canned)",
      ...
      },
      {
        ...
        name: 'i/d Puppy',
        forms: ["dry", "canned"],
        flavour: "Original (dry); Chicken & Vegetable Stew (canned)",
      ...
      },
      {
        ...
        name: 'i/d Low Fat',
        forms: ["dry", "canned"],
        flavour: "Original (dry); Rice, Vegetable & Chicken Stew (canned)",
    ...
    cats: [
      {
        ...
        name: 'Gastrointestinal',
        forms: ['dry', 'canned'],
        flavour: "Thin Slices in Gravy / Loaf (canned); Original (dry)",
      ...
      },
      {
        ...
        name: 'Gastrointestinal Moderate Calorie',
        forms: ['dry', 'canned'],
        flavour: "Thin Slices in Gravy (canned); Original (dry)",
      ...
      },
      {
        ...
        name: 'EN Gastroenteric',
        forms: ['dry', 'canned'],
        flavour: "Savory Salmon (dry); Turkey/Salmon (canned)",
      ...
      },
      {
        ...
        name: 'EN Gastroenteric Naturals',
        forms: ['dry', 'canned'],
        flavour: "Natural Salmon (dry & canned)",
        use: 'As EN Gastroenteric — natural ingredient formulation.',
      },
    ,
      {
        ...
        forms: ["dry", "canned"],
        flavour: "Stress + Digestive Care (dry & canned)",
  ...
  renal: {
    dogs: [
      ...
      },
      {
        ...
        forms: ['dry', 'canned'],
        flavour: "Aromatic (A) / Savory (S) / Thin Slices (D) / Loaf (E)",
    ...
    cats: [
      ...
      },
      {
        ...
        forms: ['dry', 'canned'],
        flavour: "Aromatic (A) / Savory (S) / Pâté (P) / Thin Slices (D) / Loaf (E) / Tuna (T)",
    ...
    ,
      {
        ...
        forms: ["dry", "canned"],
        flavour: "Original (dry); Chicken & Tuna Stew (canned)",
      ...
      },
      {
        ...
        name: 'k/d',
        forms: ["dry", "canned"],
        flavour: "Original (dry); Chicken & Vegetable Stew / Tuna (canned)",
  ...
  hepatic: {
    dogs: [
      ...
      },
      {
        ...
        forms: ['dry'],
        flavour: "Hydrolyzed soy protein (dry only)",
    ...
    cats: [
      ...
      },
      {
        ...
        forms: ['dry', 'canned'],
        flavour: "Savory Selects (dry); Turkey & Cheese (canned)",
    ...
    dogs: [
      {
        ...
        name: 'Urinary SO',
        forms: ['dry', 'canned'],
        flavour: "Loaf / Thin Slices in Gravy (canned); Original (dry)",
    ...
    cats: [
      {
        ...
        name: 'Urinary SO',
        forms: ['dry', 'canned'],
        flavour: "Thin Slices in Gravy / Loaf / Pâté (canned); Original (dry)",
    ...
    ,
      {
        ...
        name: 'Metabolic',
        forms: ["dry", "canned"],
        flavour: "Original (dry); Chicken & Seafood (canned)",
      ...
      },
      {
        ...
        name: 'w/d Multi-Benefit',
        forms: ["dry", "canned"],
        flavour: "Original (dry); Chicken (canned)",
  ...
  allergy: {
    dogs: [
      {
        ...
        tag: 'hydrolyzed',
        forms: ['dry'],
        flavour: "Hydrolyzed feather protein + pea (dry only)",
      ...
      },
      {
        ...
        tag: 'hydrolyzed',
        forms: ['dry', 'canned'],
        flavour: "Hydrolyzed soy protein (dry & canned)",
      ...
      },
      {
        ...
        tag: 'other',
        forms: ['dry', 'canned'],
        flavour: "Hydrolyzed protein blend (dry & canned)",
      ...
      },
      {
        ...
        tag: 'hydrolyzed',
        forms: ['dry'],
        flavour: "Hydrolyzed soy (vegetarian) / Hydrolyzed chicken / Hydrolyzed salmon",
    ...
    ,
      ...
      },
      {
        ...
        tag: 'novel',
        forms: ["dry"],
        flavour: "Original — egg protein + hydrolyzed corn (dry only)",
      ...
      },
      {
        ...
        tag: 'hydrolyzed',
        forms: ["dry", "canned"],
        flavour: "Hydrolyzed chicken (dry & canned)",
      ...
      },
      {
        ...
        tag: 'hydrolyzed',
        forms: ["dry"],
        flavour: "Hydrolyzed chicken (dry only)",
    ...
    dogs: [
      {
        ...
        name: 'Recovery',
        forms: ['canned', 'liquid'],
        flavour: "Loaf / Liquid (canned & liquid)",
